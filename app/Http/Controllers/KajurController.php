...
class KajurController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Query dasar untuk permintaan surat yang belum disetujui
        $query = LetterRequests::where('status', 'pending')
        ...
        return view('ketua_staff.kajur.index', compact('pendingRequests', 'letterTemplates'));
    }
