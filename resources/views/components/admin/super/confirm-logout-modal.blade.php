<div id="confirm-logout-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 px-4">
    <div class="bg-white rounded-xl p-6 max-w-sm w-full">
        <div class="text-center">
            ...
            <svg class="w-6 h-6 text-red-600 text-cen" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
            </svg>
            </div>
        </div>
            <h3 class="text-lg font-semibold text-gray-900 mb-2 text-center">Konfirmasi Keluar</h3>
            <p class="text-gray-600 text-sm mb-4 text-center">Apakah anda yakin ingin keluar?</p>
