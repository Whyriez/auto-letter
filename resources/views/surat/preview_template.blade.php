                ...
                <td style="width: 50%; text-align: center; vertical-align: top;">
                    <div class="signature-block">
                        @if ($signer->role === 'kaprodi')
                            <p style="font-weight: 600; margin-bottom: 1rem;">Ketua Program Studi <br> {{ $signer->prodi }}
                            </p>
                        @elseif ($signer->role === 'kajur')
                            <p style="font-weight: 600; margin-bottom: 1rem;">Ketua Jurusan <br> {{ $signer->jurusan }}</p>
                        @else
