    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-2xl card-shadow overflow-hidden mb-8">
                ...
                <div class="p-6 sm:p-8">
                    @if ($status === 'valid')
                        ...
                        <div>
                            <div class="flex items-start space-x-4">
                                <div
                                    class="success-gradient w-16 h-16 rounded-full flex items-center justify-center status-animation">
                            ...
                            <div class="mt-8 text-center">
                                @if ($status === 'valid')
                                    <a href="{{ $documentUrl }}" target="_blank"
                                        class="inline-flex bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-200 card-shadow text-center">
                    ...
                    @elseif ($status === 'mismatched')
                        ...
                        <div class="flex items-start space-x-4">
                            <div
                                class="error-gradient w-16 h-16 rounded-full flex items-center justify-center status-animation">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
            ...
            @if ($status === 'valid')
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="info-card bg-gray-50 rounded-xl p-5">
                                ...
                                <p class="text-lg font-semibold text-gray-900">
                                    {{ $letter->letterTemplate->nama_surat ?? 'Tidak Diketahui' }}</p>
                            </div>
                            ...
                            <div class="info-card bg-gray-50 rounded-xl p-5">
                                ...
                                <p class="text-lg font-semibold text-gray-900">
                                    {{ $letter->created_at->format('M d, Y') }}</p>
                            </div>
                ...
                <div class="bg-white rounded-2xl card-shadow overflow-hidden mb-8">
                    <div
                        class="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 sm:px-8 py-4 border-b border-gray-200">
                        <h3 class="text-xl font-bold text-gray-900 flex items-center">
                            <svg class="w-6 h-6 mr-2 text-indigo-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 11H5m14-7H3a1 1 0 00-1 1v11a1 1 0 001 1h16a1 1 0 001-1V5a1 1 0 00-1-1zM9 7h6">
                                </path>
                            </svg>
                            Hash Blockchain
                        </h3>
                    ...
                    <div class="p-6 sm:p-8">
                        <div class="hash-display rounded-xl p-6">
                            ...
                            <code
                                class="text-sm font-mono text-gray-700 bg-white p-3 rounded-lg block leading-relaxed">
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                ...
                                <button onclick="copyHash('{{ $letter->blockchain_hash }}')"
                                    class="text-blue-600 hover:text-blue-800 text-xs font-medium bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-lg transition-colors">
                                    Copy Hash
                                </button>
                            </div>
                        </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="/"
                    class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-gray-200 card-shadow">
                    <div class="flex items-center justify-center">
    ...
    <script>
        ...
        function showNotification(message, type = 'success') {
            ...
            notification.className =
                `fixed top-4 right-4 bg-gradient-to-r ${colors[type]} text-white px-6 py-4 rounded-lg shadow-lg z-50 transform translate-x-full transition-transform duration-300`;
